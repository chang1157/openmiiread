...
public class BookInfoEditActivity extends MBaseActivity {
    ...
    protected void initData() {
        ...
        if (!TextUtils.isEmpty(noteUrl)) {
            ...
            SearchBookBean searchBookBean = getIntent().getParcelableExtra("searchBook");
            if (searchBookBean != null) {
                tieBookName.setText(searchBookBean.getName());
                tieBookAuthor.setText(searchBookBean.getAuthor());
                tieBookJj.setText(searchBookBean.getIntroduce());
                tieCoverUrl.setText(searchBookBean.getCoverUrl());
                Glide.with(this).load(searchBookBean.getCoverUrl())
                ...
                tvChangeCover.setVisibility(View.GONE);
                tvRefreshCover.setVisibility(View.GONE);
