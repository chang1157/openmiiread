...
public abstract class PageLoader {
    ...
    private void setUpTextParams() {
        ...
        // 行间距(大小为字体的一半)
        mTextInterval = (int) (mTextSize * readBookControl.getLineSpacing() / 2);
        mTitleInterval = (int) (mTitleSize * readBookControl.getLineSpacing() / 2);
        // 段落间距(大小为字体的高度)
        mTextPara = (int) (mTextSize * readBookControl.getLineSpacing() * readBookControl.getParagraphSize() / 2);
        mTitlePara = (int) (mTitleSize * readBookControl.getLineSpacing() * readBookControl.getParagraphSize() / 2);
    }
