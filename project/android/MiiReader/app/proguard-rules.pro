...
# 消除bottomNavigationView动画
-keep class android.support.design.internal.BottomNavigationMenuView {*;}

-keep public class site.xapps.calculator.anr.R$*{
    public static final int *;
}
...
-keep class com.moses.miiread.model.analyzeRule.**{*;}
...
-keep class com.moses.miiread.widget.**{*;}
-keep class com.moses.miiread.bean.**{*;}
-keep class android.support.**{*;}
...
-keep public class com.moses.miiread.R$*{
    public static final int *;
}
