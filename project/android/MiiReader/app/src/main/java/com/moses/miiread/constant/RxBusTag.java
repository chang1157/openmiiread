...
public class RxBusTag {
    ...
    public final static String RESTORE_BOOK_SOURCE_FROM_SERVER = "restoreBookSourceFromServer";

    public final static String READ_BOOK_UP_BAR = "READ_BOOK_UP_BAR";
    public final static String READ_BOOK_RECREATE = "READ_BOOK_RECREATE";
    public final static String READ_BOOK_REFRESH_PAGE = "READ_BOOK_REFRESH_PAGE";
    public final static String READ_BOOK_KEEP_SCREEN_ON_CHANGE = "READ_BOOK_KEEP_SCREEN_ON_CHANGE";
    public static final String AUDIO_DUR = "AUDIO_DUR";
