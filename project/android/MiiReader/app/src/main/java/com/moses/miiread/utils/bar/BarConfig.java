package com.moses.miiread.utils.bar;
...
/**
 * Created by origin on 2017/5/11.
 */
...
class BarConfig {
    ...
    private final int mNotchBarHeight;
    ...
    public BarConfig(Activity activity) {
        ...
        mNotchBarHeight = getNotchBarHeight(activity);
    ...
    private int getNotchBarHeight(Context context) {
