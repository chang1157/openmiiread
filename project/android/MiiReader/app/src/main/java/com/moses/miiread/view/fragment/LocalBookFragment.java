...
import com.moses.miiread.help.media.MediaStoreHelper;
...
import com.moses.miiread.widget.recycler.refresh.RefreshLayout;

/**
 * Created by origin on 17-5-27.
 * 本地书籍
 */
...
public class LocalBookFragment extends BaseFileFragment {
    ...
    private void setUpAdapter() {
        ...
        if (getContext() != null) {
            ...
            mRvContent.addItemDecoration(new DividerItemDecoration(getContext(), false));
