package com.moses.miiread.widget.recycler.expandable;
...
import com.moses.miiread.widget.recycler.expandable.bean.BaseItem;
...
import static com.moses.miiread.widget.recycler.expandable.BaseExpandAbleViewHolder.VIEW_TYPE_CHILD;
import static com.moses.miiread.widget.recycler.expandable.BaseExpandAbleViewHolder.VIEW_TYPE_PARENT;
...
public abstract class BaseExpandableRecyclerAdapter<G, C, VH extends BaseExpandAbleViewHolder> extends RecyclerView.Adapter<VH> {
     ...
     * child datas
     */
    private List<List<C>> childDatas;
    ...
    public BaseExpandableRecyclerAdapter(Context ctx, List<RecyclerViewData<G, C>> datas) {
        this.ctx = ctx;
        this.allDatas = datas;
        setShowingDatas();
    ...
    public void onBindViewHolder(@NonNull final VH holder, final int position) {
        ...
        if (item != null && item instanceof GroupItem) {
            ...
            onBindGroupHolder(holder, gp, position, (G) ((GroupItem) item).getGroupData());//放在最后，以保证对子项设置监听有效。
        } else {
            ...
            onBindChildHolder(holder, gp, cp, position, (C) item);//放在最后，以保证对子项设置监听有效。
        }
    }

    private boolean alwaysExpandGrp = false;

    public boolean isAlwaysExpandGrp() {
        return alwaysExpandGrp;
    }

    public void setAlwaysExpandGrp(boolean alwaysExpandGrp) {
        this.alwaysExpandGrp = alwaysExpandGrp;
    }
     ...
     * @param position
     */
    public abstract void onBindGroupHolder(VH holder, int groupPos, int position, G groupData);
     ...
     * @param position
     */
    public abstract void onBindChildHolder(VH holder, int groupPos, int childPos, int position, C childData);
