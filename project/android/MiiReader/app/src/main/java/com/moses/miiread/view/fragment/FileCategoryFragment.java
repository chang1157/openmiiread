...
import com.moses.miiread.utils.FileStack;
import com.moses.miiread.utils.FileUtils;
import com.moses.miiread.view.adapter.FileSystemAdapter;
...
public class FileCategoryFragment extends BaseFileFragment {
    ...
    private void setUpAdapter() {
        ...
        mRvContent.addItemDecoration(new DividerItemDecoration(Objects.requireNonNull(getContext()), false));
...
//                            || pathname.getName().toLowerCase().endsWith(FileHelp.SUFFIX_MOBI)
//                            || pathname.getName().toLowerCase().endsWith(FileHelp.SUFFIX_PDF)
                    ));
        }
    }
}
