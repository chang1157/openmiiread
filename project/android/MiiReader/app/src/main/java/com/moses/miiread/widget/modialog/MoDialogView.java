...
import com.moses.miiread.utils.ReadAssets;
...
public class MoDialogView extends LinearLayout {
    ...
    public void showSimpleList(String[] items, OnItemClickListenerTwo onItemClickListenerTwo, String... extraActionTxt) {
        removeAllViews();
        LayoutInflater.from(getContext()).inflate(R.layout.mo_dialog_simple_list, this, true);
        RecyclerView rv_list = findViewById(R.id.rv_list);
        rv_list.setLayoutManager(new LinearLayoutManager(getContext()));
        rv_list.setAdapter(new JoinQQGroupAdapter(getContext(), items, items, onItemClickListenerTwo, extraActionTxt));
    }
    ...
    public void showImageText(Bitmap bitmap, String text) {
        ...
        View view = findViewById(R.id.cv_content);
        view.setOnClickListener(null);
        ImageView imageView = findViewById(R.id.image_view);
        TextView tvCanCopy = findViewById(R.id.tv_can_copy);
        int imageWidth = Math.min(view.getWidth(), view.getHeight());
