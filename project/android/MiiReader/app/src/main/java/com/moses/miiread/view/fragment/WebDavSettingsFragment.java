...
import com.moses.miiread.help.ProcessTextHelp;
import com.moses.miiread.help.WebDavHelp;
...
public class WebDavSettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference.getKey().equals("web_dav_restore")) {
            ...
            Single.create((SingleOnSubscribe<String[]>) emitter -> {
                List<WebDavFile> webDavFiles = new WebDavFile(WebDavHelp.getWebDavUrl() + getString(R.string.local_folder_name) + "/").listFiles();
                            ...
                            if (strings.length > 0) {
                                AlertDialog dialog = new AlertDialog.Builder(settingActivity)
                                        ...
                                        .setSingleChoiceItems(strings, 0, (dialogInterface, i) -> {
                                            restore(WebDavHelp.getWebDavUrl() + getString(R.string.local_folder_name) + "/" + strings[i]);
    ...
    public void restore(String url) {
        Single.create(emitter -> {
            ...
            ZipUtils.unzipFile(zipFilePath, FileUtils.getSdCardPath() + "/" + getString(R.string.local_folder_name));
